...
public interface DeviceDetail_osConst {

    /**
     * Enum of role names.
     */
    public static enum OS implements RoleConstant, AssociationRoleConstant {
        /** Constant denoting the DeviceDetail_os object selection*/
        DEVICE_DETAIL_OS("DeviceDetail_os", null, null),
        /** Constant denoting the role Device (domain class: Device) */
        DEVICE("Device", "", ""),
        /** Constant denoting the role metrics (domain class: DeviceMetrics) */
        METRICS("metrics", "metrics", "metrics"),
        /** Constant denoting the role Command (domain class: Command) */
        COMMAND("Command", "", ""),
        ;
    ...
    /**
     * Enum of Device's attribute constants.
     */
    public static enum DEVICE implements AttributeConstant {
        /** The id constant */
        ID("Device.id", false, false,
          "", null, null, String.class, null),
        /** The deviceType constant */
        DEVICE_TYPE("Device.deviceType", false, false,
          "", null, null, String.class, null),
        /** The updateTime constant */
        UPDATE_TIME("Device.updateTime", true, false,
        ...
        /** The role name */
        private static String roleName = "DeviceDetail_os";
         ...
         */
        private DEVICE(String title, boolean javaPrimitive,
        ...
        public static synchronized List<Key> getKeys() {
            if (uniqueKeys == null) {
                ...
                Key key;
                key = new Key(OS.DEVICE,
                        "id", // key name
                        new AttributeConstant[]
                            {
                                DeviceDetail_osConst.DEVICE.ID,
                            }
                    );
         ...
         */
        public static Enum<DEVICE> constValue(String attributeName) {
            String attr;
    ...
    public static enum METRICS implements AttributeConstant {
        ...
        /** The role name */
        private static String roleName = "Device";
    ...
    /**
     * Enum of Command's attribute constants.
     */
    public static enum COMMAND implements AttributeConstant {
        /** The command constant */
        COMMAND("Command.command", false, false,
          "", null, null, String.class, null),
        /** The level constant */
        LEVEL("Command.level", true, false,
          "", null, null, Integer.class, null),
        ;
         ...
         * @param foreignAttributeRole the foreignAttributeRole as a String
         */
        private COMMAND(String title, boolean javaPrimitive,
                boolean foreignAttribute, String displayRule,
                String converterId, String validatorId, Class<?> attributeType, RoleConstant foreignAttributeRole) {
         ...
         *         <code>null</code> if no such enum exists
         */
        public static Enum<COMMAND> constValue(String attributeName) {
            String attr;
            if (attributeName.indexOf('.') == -1) {
                attr = roleName + "." + attributeName;
            } else {
    ...
    public static class OSRoleFactory {
        ...
        public static Map<RoleConstant, OSRole<?>> getRoleMap() {
            ...
            role = new DeviceRole(parent, rt, rc);
            roleMap.put(role.getRoleConstant(), role);


            // The metrics node
            parent = roleMap.get(DeviceDetail_osConst.OS.DEVICE);
            ...
            rt = RelationType.ROOT;
            rc = RelationCardinality.ROOT;
            role = new CommandRole(parent, rt, rc);
            roleMap.put(role.getRoleConstant(), role);
